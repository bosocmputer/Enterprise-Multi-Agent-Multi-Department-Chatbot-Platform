...
- Next safest implementation step: deploy the domain-agnostic core, smoke Telegram with clear inventory queries plus ambiguous staff-style messages, and then add a second mock auto-parts profile/fixture before real customer cutover.
